...
6 ifT<>32andT=vpeek(A+U)andT=vpeek(A+2*U)thenforN=0to2:vpokeA+N*U,32:nextN:H=H+1
7 nextI,J:swapU,V:nextK:ifH>0thenP=P+H:W=0:goto3:elseifW>0then2:elseW=2
