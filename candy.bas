...
3 forI=0to3:locate7+I*4,22:?S(I);:vpoke6144+7++22*32+1+4*(I),I+1:nextI:H=0:FORI=0TO4:G=B+I*2:ifvpeek(G)=32thenvpokeG,RND(1)*4+1
4 M1$="T120O4L15A":forJ=4TO1step-1:A=G+J*64:ifvpeek(A)=32thenvpokeA,vpeek(A-64):vpokeA-64,32:H=1
...
3 forI=0to3:locate0,16+I*2:?S(I):vpoke6144+32*16+64*(I),I+1:nextI:H=0:FORI=0TO4:G=B+I*2:ifvpeek(G)=32thenvpokeG,RND(1)*4+1
