...
2 H=0:FORI=0TO4:A=B+I*2:ifvpeek(A)=32thenvpokeA,RND(1)*4+1:H=1
3 forJ=4TO1step-1:A=B+I*2+J*64:ifvpeek(A)=32thenvpokeA,vpeek(A-64):vpokeA-64,32:H=1
4 nextJ,I:ifH=1then2:elseforK=0to1:swapU,V:forJ=0TO4:forI=0TO2:A=B+J*V+I*U:T=vpeek(A)
5 ifT=vpeek(A+U)andT=vpeek(A+2*U)thenvpokeA,32:vpokeA+U,32:vpokeA+2*U,32:H=1
6 nextI,J,K:ifH=1thenY=X:Z=X:goto2elseT=vpeek(Y):vpokeY,vpeek(Z):vpokeZ,T
